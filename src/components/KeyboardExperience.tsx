...
const CLOUDINARY_BASE_URL = "https://res.cloudinary.com/dacwce9cv/image/upload/q_auto/f_auto/v1780960540";
...
export default function KeyboardExperience() {
  ...
  useEffect(() => {
    ...
    for (let i = 0; i < FRAME_COUNT; i++) {
      ...
      // Pulls perfectly named frames straight from your clean Cloudinary URL
